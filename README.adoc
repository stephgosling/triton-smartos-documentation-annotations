...
A USB 3.0 stick takes approximately 10 minutes to copy the files. If not booting
from a pool use the fastest USB disk you can find as this can save several
minutes for each reboot.
